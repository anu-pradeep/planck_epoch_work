...
class registerState extends State<register>
{
  ...
  Widget build(BuildContext context) {
   return Scaffold(
    ...
    Padding(padding: const EdgeInsets.only(right: 350),
    child: Text("Register",style: GoogleFonts.abel(fontSize: 30,color: Colors.lightBlue[900]),),),
    const SizedBox(height: 10),

    Padding(padding: const EdgeInsets.only(right: 280),
    child: Text("Please register to login",style: GoogleFonts.aBeeZee(fontSize: 15,color: Colors.lightBlue[900])),),
    Padding(padding: const EdgeInsets.only(top: 20,left: 20,right: 20),

    child: TextFormField(
    decoration: InputDecoration(
    prefixIcon: const Icon(Icons.person,color: Colors.lightBlue,), labelText: "user name" ,
      labelStyle:TextStyle(color: Colors.lightBlue[100],fontSize: 10), hintText: "user name",
             ...
             Padding(padding: const EdgeInsets.only(top: 20,left: 20,right: 20),
               child: TextFormField(
                 decoration: InputDecoration(
                   ...
                   labelText: "Mobile number" ,labelStyle:TextStyle(color: Colors.lightBlue[100],fontSize: 10),
                   hintText: "Mobile number",hintStyle: TextStyle(color: Colors.lightBlue[50],fontSize: 10),
                   border:OutlineInputBorder(borderRadius:BorderRadius.circular(150)),
                   enabledBorder: OutlineInputBorder(
                     borderRadius: BorderRadius.circular(25.0),
                     borderSide:  BorderSide(color: Colors.blue),
    ...
    borderSide:  BorderSide(color: Colors.blue),
             ...
             SizedBox(
               ...
               child: ElevatedButton(onPressed: (){},
                 ...
                 child: Text("Sign up",style: GoogleFonts.aBeeZee(fontSize: 15,color: Colors.white),),),
             ),
             SizedBox(height: 25),
             TextButton(onPressed: (){}, child: Text("Already have account.? Sign In",style: GoogleFonts.aBeeZee(color: Colors.lightBlue[900]),))
           ])
   )));
  }
